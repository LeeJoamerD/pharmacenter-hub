-- Fix: Add missing NOT NULL columns (pays, symbole_devise) to the INSERT statement
-- and normalize systeme_comptable value
...
BEGIN
  ...
  -- Mise à jour des paramètres régionaux avec TOUTES les colonnes NOT NULL
