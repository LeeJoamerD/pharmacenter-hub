-- Phase 1: Extension de la table documents (corrected)
...
-- Insertion des nouvelles catégories de documents (correct table name)
INSERT INTO document_categories (tenant_id, name, description, color, icon, is_system) 
SELECT 
  NULL as tenant_id, 
  name,
  description,
