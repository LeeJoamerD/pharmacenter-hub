-- Restaurer la fonction check_pharmacy_email_exists
-- Cette fonction vérifie l'existence d'un email pharmacie et son statut d'authentification
...
-- Grant permissions
GRANT EXECUTE ON FUNCTION public.check_pharmacy_email_exists(text) 
TO anon, authenticated;

-- Documentation
COMMENT ON FUNCTION public.check_pharmacy_email_exists IS 
'Vérifie si un email pharmacie existe et retourne son statut d''authentification';