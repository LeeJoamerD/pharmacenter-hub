-- ============================================
-- CORRECTION SÉCURISÉE: get_dashboard_stock_metrics
-- Changement UNIQUEMENT du calcul "availableProducts"
-- AVANT: stock > seuil_faible (produits normaux seulement)
-- APRÈS: stock > 0 (tous produits disponibles: critique + faible + normal + surstock)
-- ============================================
...
BEGIN
  ...
  -- Retourner le résultat JSON (format identique)
...
'Calcule les métriques de stock. Disponibles = TOUS produits avec stock > 0 (critique + faible + normal + surstock)';