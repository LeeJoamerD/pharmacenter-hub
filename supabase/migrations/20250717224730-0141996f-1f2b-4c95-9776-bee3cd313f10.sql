-- ========================================
-- PLAN D'IMPLÉMENTATION FINAL COMPLET
-- ========================================
...
CREATE OR REPLACE TRIGGER update_roles_permissions_updated_at
    BEFORE UPDATE ON public.roles_permissions
    FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();

CREATE OR REPLACE TRIGGER update_security_alerts_updated_at
...
CREATE OR REPLACE TRIGGER update_security_incidents_updated_at
