-- Migration corrigée pour nettoyer les données de test
-- Suppression seulement des tables qui existent
...
-- 11. Supprimer les pharmacies
DELETE FROM pharmacies;

-- 12. Supprimer les utilisateurs d'authentification
