-- Fix UUID type error in register_pharmacy_with_admin function
-- The issue: record_id column expects UUID but was being cast to TEXT
...
BEGIN
  ...
  -- 3. Logger l'inscription dans l'audit avec le type UUID correct (pas de cast ::text)
  INSERT INTO public.audit_logs (
    ...
    'pharmacies', 
    new_pharmacy_id,  -- ✅ CORRECTION: UUID natif sans cast ::text
    jsonb_build_object(
...
EXCEPTION WHEN OTHERS THEN
  -- Logger l'erreur avec gestion correcte des types UUID
  INSERT INTO public.audit_logs (
...
-- Documentation
COMMENT ON FUNCTION public.register_pharmacy_with_admin IS 
'Crée une nouvelle pharmacie avec son administrateur. Correction du type record_id (UUID au lieu de TEXT).';