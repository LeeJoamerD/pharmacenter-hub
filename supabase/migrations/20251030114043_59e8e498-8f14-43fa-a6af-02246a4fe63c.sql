-- ===================================================================
-- RESTAURATION DES FONCTIONS RPC DE STOCK
-- Fonctions pour optimiser les requêtes de stock et corriger les erreurs
-- Source: migrations_backup 20251016222508 et 20251016163432
-- ===================================================================

-- 1. Fonction principale pour calculer les métriques de stock (CRITIQUE)
...
-- 2. Fonction pour calculer les métriques de stock faible
...
-- 3. Fonction pour calculer les métriques de rupture de stock
...
-- 4. Fonction pour calculer les métriques de valorisation globale
...
-- 5. Fonction pour calculer la valorisation par famille
...
-- 6. Fonction pour calculer la valorisation par rayon
