-- Fix: Remove reference to non-existent 'pays' column in accounting_general_config
-- Instead, derive code_pays from parametres_plan_comptable_regionaux or from the plan code
...
BEGIN
  ...
  -- Récupérer les informations du plan global AVANT de déterminer le code pays
