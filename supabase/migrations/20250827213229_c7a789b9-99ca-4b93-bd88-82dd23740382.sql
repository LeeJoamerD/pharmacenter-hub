...
VALUES 
  ('read', 'Lecture des données', 'Permet de lire les données du système', 'Général', true),
  ('write', 'Modification des données', 'Permet de modifier les données du système', 'Général', true),
  ('delete', 'Suppression des données', 'Permet de supprimer les données du système', 'Général', true),
  ('admin', 'Administration système', 'Accès complet aux fonctionnalités administratives', 'Administration', true),
  ('backup', 'Gestion des sauvegardes', 'Permet de créer et gérer les sauvegardes', 'Administration', true),
  ('reports', 'Génération de rapports', 'Permet de générer et consulter les rapports', 'Rapports', true)
