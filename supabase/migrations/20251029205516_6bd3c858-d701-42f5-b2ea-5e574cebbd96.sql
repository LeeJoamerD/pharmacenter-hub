-- =========================================================================
-- Migration: Restauration des tables de configuration des ventes
-- Source: supabase/migrations_backup_original/20250818023755_0a7983c2-8b6f-4703-b4a0-88c0ab74310d.sql
-- Description: Restauration des tables pricing_settings, margin_rules, stock_settings,
--              alert_settings, alert_thresholds_by_category avec RLS et triggers
-- =========================================================================

-- 1. Create stock_settings table
...
-- 5. Create alert_thresholds_by_category table
