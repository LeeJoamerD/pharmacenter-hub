...
CREATE TABLE public.pharmacies (
  ...
  email TEXT,
  region TEXT,
  type TEXT DEFAULT 'standard', -- standard, hospitalière, rurale, etc.
...
CREATE TABLE public.network_channels (
  ...
  name TEXT NOT NULL,
  description TEXT,
  type TEXT DEFAULT 'public', -- public, private, broadcast, emergency
...
CREATE TABLE public.network_messages (
  ...
  message_type TEXT DEFAULT 'text', -- text, alert, document, image
  priority TEXT DEFAULT 'normal', -- low, normal, high, urgent
  read_by JSONB DEFAULT '[]', -- array des IDs pharmacies qui ont lu
...
INSERT INTO public.pharmacies (name, code, address, city, postal_code, phone, email, region, type) VALUES
  ...
  ('Pharmacie Rurale', 'PH003', '22 Route Nationale', 'Provence', '13600', '04.90.12.34.56', 'contact@pharmacie-rurale.fr', 'Provence-Alpes-Côte d\'Azur', 'rurale'),
  ('Pharmacie Hospitalière', 'PH004', 'CHU Marseille', 'Marseille', '13005', '04.91.38.60.00', 'pharma@chu-marseille.fr', 'Provence-Alpes-Côte d\'Azur', 'hospitalière');
