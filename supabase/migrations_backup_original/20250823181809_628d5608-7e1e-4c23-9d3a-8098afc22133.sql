...
CREATE POLICY IF NOT EXISTS "Users can insert audit logs in their tenant" 
...
CREATE POLICY IF NOT EXISTS "Users can insert security alerts in their tenant" 
ON public.security_alerts 
FOR INSERT 
WITH CHECK (tenant_id = public.get_current_user_tenant_id());

-- UPDATE: Permettre la résolution par Admin/Pharmacien
CREATE POLICY IF NOT EXISTS "Admins can resolve security alerts in their tenant" 
ON public.security_alerts 
FOR UPDATE 
USING (
  tenant_id = public.get_current_user_tenant_id() 
...
CREATE POLICY IF NOT EXISTS "Allow login attempt logging" 
...
CREATE POLICY IF NOT EXISTS "Users can create sessions in their tenant" 
...
CREATE POLICY IF NOT EXISTS "Users can update their own sessions or admins can update all" 
ON public.user_sessions 
FOR UPDATE 
USING (
  tenant_id = public.get_current_user_tenant_id()
