...
-- Corriger les types enum pour la migration
...
SELECT 
  ...
  photo_identite,
  salaire_base,
  situation_familiale::situation_familiale_enum, -- Cast vers enum
  nombre_enfants,
  numero_cnss,
  statut_contractuel::statut_contractuel_enum,   -- Cast vers enum
...
-- Créer une table temporaire pour mapper les IDs
