-- Corriger la fonction register_pharmacy_with_admin
...
BEGIN
  ...
  INSERT INTO public.pharmacies (
    id, tenant_id, name, code, address, quartier, arrondissement, city, region, pays, 
...
EXCEPTION WHEN OTHERS THEN
  -- Logger l'erreur avec le tenant_id de la pharmacie créée (ou un défaut)
  INSERT INTO public.audit_logs (
    tenant_id, user_id, action, table_name, new_values, status, error_message
  ) VALUES (
    COALESCE(new_pharmacy_id, gen_random_uuid()), -- Utiliser l'ID créé ou générer un défaut
    current_user_id,
