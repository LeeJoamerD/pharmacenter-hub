        ...
        <CardContent>
          <div className="grid grid-cols-12 gap-6">
            ...
            <div className="col-span-4 space-y-4">
              <h3 className="text-lg font-semibold text-foreground">Rôles</h3>
              <div className="space-y-2">
            ...
            {/* Bloc 2: Permissions pour le rôle sélectionné */}
            <div className="col-span-8 space-y-4">
              ...
              <div className="mt-6 pt-6 border-t">
                <Button onClick={handleSaveRolePermissions} className="w-full">
                  Sauvegarder les permissions pour {availableRoles.find(r => r.id === selectedRole)?.name}
                </Button>
              </div>
            </div>
          </div>
