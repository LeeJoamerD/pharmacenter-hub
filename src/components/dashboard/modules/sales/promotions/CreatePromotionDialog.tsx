...
const CreatePromotionDialog = () => {
  ...
  const [formData, setFormData] = useState({
    nom: '',
    description: '',
    type_promotion: 'Pourcentage' as any,
    valeur_promotion: 0,
    montant_minimum: 0,
    date_debut: '',
    date_fin: '',
    ...
    heure_fin: '',
    est_actif: true,
    cible_clients: 'Tous' as any,
    limite_utilisations: undefined as number | undefined,
    limite_par_client: 1,
    priorite: 0,
    combinable: false,
    code_promo: '',
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="flex items-center space-x-2">
              ...
              />
              <Label htmlFor="est_actif">Activer immédiatement</Label>
            </div>
