    ...
    Tables: {
      ...
      inventaire_lignes: {
        Row: {
          ...
          date_comptage: string | null
          emplacement_reel: string | null
          emplacement_theorique: string | null
          id: string
          lot_id: string | null
          metadata: Json | null
          notes: string | null
        ...
        Relationships: [
          {
            foreignKeyName: "inventaire_lignes_session_id_fkey"
            columns: ["session_id"]
            isOneToOne: false
            referencedRelation: "inventaire_sessions"
            referencedColumns: ["id"]
      ...
      produits: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "fk_produits_laboratoires"
            columns: ["laboratoires_id"]
            isOneToOne: false
